...
const __FILE__GUANCECOM_LOAD_FROM_CDN = fs.readFileSync(path.join(__dirname, '../guancecom-load-from-cdn-45fc21.js'), 'utf-8').trim();
...
const __FILE__GUANCECOM_INIT = fs.readFileSync(path.join(__dirname, '../guancecom-init-9f37c1.js'), 'utf-8').trim();
