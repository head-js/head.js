// https://github.com/dcloudio/uni-app/blob/next/packages/uni-h5/src/service/api/base/getBrowserInfo.ts
...
export function getBrowserInfo() {
  ...
  let browserName = ''
  let browserVersion = '-1'; // String(IEVersion())
  if (browserVersion !== '-1') {
    browserName = 'IE'
  } else {
